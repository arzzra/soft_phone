...
func ExampleWithFromDisplay() {
	...
	// В реальном коде:
	// dialog, err := uasuac.CreateDialog(ctx, remoteURI, opts...)
...
// Example_callOptions_priority демонстрирует установку приоритета звонка
func Example_callOptions_priority() {
...
func Example_complexCall() {
	...
	// Совершаем звонок
	_, err = uasuac.CreateDialog(ctx, remoteURI, opts...)
	if err != nil {
