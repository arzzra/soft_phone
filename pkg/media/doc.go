...
//
// Пакет поддерживает все стандартные SDP направления:
//
//   - DirectionSendRecv - полнодуплексная связь (по умолчанию)
//   - DirectionSendOnly - только отправка
//   - DirectionRecvOnly - только прием
//   - DirectionInactive - медиа поток неактивен
//
...
// # Thread Safety
//
// Все публичные методы MediaSession являются thread-safe и могут вызываться
