...
### 5️⃣ Симуляция передачи аудио данных
- Отправка тестовых аудио пакетов между сессиями
- Демонстрация bidirectional коммуникации
- Эмуляция real-time передачи с паузами 20ms
...
🎵 Симуляция аудио потоков...
   📤 Caller отправляет пакет 1 (160 байт)
   📥 Callee отправляет пакет 1 (160 байт)
   📤 Caller отправляет пакет 2 (160 байт)
   📥 Callee отправляет пакет 2 (160 байт)
   📤 Caller отправляет пакет 3 (160 байт)
   📥 Callee отправляет пакет 3 (160 байт)
   📤 Caller отправляет пакет 4 (160 байт)
   📥 Callee отправляет пакет 4 (160 байт)
   📤 Caller отправляет пакет 5 (160 байт)
   📥 Callee отправляет пакет 5 (160 байт)
